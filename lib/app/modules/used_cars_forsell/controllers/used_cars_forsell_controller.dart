...
class UsedCarsForsellController extends GetxController {
  ...
  void itemsPagination(
    ...
    try {
      ...
      var response = await http.get(
          'ServiceUsedCar/Search?regionId=${regionId.toString()}&carTypeId=${cartypeId.toString()}&modelId=${modelId.toString()}&yearId=${yearId.toString()}&areaId=${area.toString()}&pageIndex=${index.toString()}&pageSize=20');
      // print(response.data);
      for (var item in response.data) {
...
//Car Items
  ...
  void getusedCarList({regionId, carTypeId, modelId, yearId, areaId}) async {
    ...
    try {
      var response = await http.get(
          'ServiceUsedCar/Search?regionId=${regionId.toString()}&carTypeId=${cartypeId.toString()}&modelId=${modelId.toString()}&yearId=${yearId.toString()}&areaId=${governorateid.value}&pageIndex=0&pageSize=20');
      // print(response.data);
